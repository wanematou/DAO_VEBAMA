...
@include('./layouts/outils')
 <div class="col-md-9 col-lg-10">
   ...
   <div class="colgnrl">
    <a href="/forma" class="col1"><img src="{{ asset('image/secretaire.png') }}" alt="secretaire" width="200" height="200" class="">
      <p>Enregistrer secretaire</p></a>
    ...
    <div class="colgnrl">
      <a href="/liste" class="col3"><img src="{{ asset('image/carte.png') }}" alt="secretaire" width="200" height="200" class="">
        <p>Imprimer carte</p></a>
      <a href="/liste" class="col4"><img src="{{ asset('image/liste.png') }}" alt="secretaire" width="200" height="200" class="">
      <p>Consulter liste</p></a>
    </div>

  </div>
</div>
<div class="deconnexion"><a href="/logout">Deconnexion</a></div>
</body>
</html>
